...
export const MEMBERSHIPS = [
  {
    ...
    features: ["10g de flor medicinal por mes","Evaluación inicial sin cargo","Gestión REPROCANN incluida","Envío nacional por Andreani","Perfil de cannabinoides del lote"],
    featured: false,
  ...
  },
  {
    ...
    features: ["20g de flor medicinal por mes","Evaluación inicial sin cargo","Gestión REPROCANN incluida","Envío nacional por Andreani","Perfil de cannabinoides del lote","Selección de variedad disponible"],
    featured: false,
  ...
  },
  {
    ...
    features: ["30g de flor medicinal por mes","Evaluación inicial sin cargo","Gestión REPROCANN incluida","Envío nacional por Andreani","Perfil de cannabinoides del lote","Selección de variedad disponible","Seguimiento médico incluido"],
    featured: false,
  ...
  },
  {
    ...
    features: ["40g de flor medicinal por mes","Evaluación inicial sin cargo","Gestión REPROCANN incluida","Envío nacional por Andreani","Perfil de cannabinoides del lote","Selección de variedad disponible","Seguimiento médico prioritario"],
    featured: false,
